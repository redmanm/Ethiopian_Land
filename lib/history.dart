...
class _MyCustomUIState extends State<History>
          ...
          ListView(
            ...
            children: [
              ...
              groupOfCards(
                  ...
                  'Abba Jiffar ',
                  'images/jima.jpg',
                  const DetailHistoryOfJima(),
                  'Blue Nile',
                  'Ethipia',
                  'images/blue_nile.jpg',
                  const DetailHistoryOfBlueNile()),
              groupOfCards(
                  'Ethipoa',
                  'Ethiopia',
                  'images/bahirdar.jpg',
                  const DetailHistoryOfBahirdar(),
                  'Benishangul',
                  'Ehiopia',
                  'images/benish.jpg',
                  const DetailHistoryOfBenishangul()),
              groupOfCards(
                  'Danacil Volcano',
                  'Ehiopia',
                  'images/d_volca_danakil.jpg',
                  const DetailHistoryOfVolcano(),
                  'Forset',
                  'Ehiopia',
                  'images/forest.jpg',
                  const DetailHistoryOfEthioForset()),
              groupOfCards(
                  'Ehiopian Flag',
                  'Ehiopia',
                  'images/flag.jpg',
                  const DetailHistoryOfFlag(),
                  'Coffee',
                  'Ehiopia',
                  'images/jabana.jpg',
                  const DetailHistoryOfCoffe()),
              groupOfCards(
                  'Andinet Park',
                  'Addis Abeba',
                  'images/andinetpark.jpg',
                  const DetailHistoryOfAndinetPark(),
                  'Addis Abeba',
                  'Ethiopia',
                  'images/addis.jpg',
                  const DetailHistoryOfAddisAbeba()),
              groupOfCards(
                  'Park',
                  'Ehiopia',
                  'images/andnet.jpg',
            ...
            child: IconButton(
              ...
              onPressed: () {
                Navigator.of(context).push(
                  MyFadeRoute(
                    route: const DetailHistoryOfCoffe(), page: build(context),
                    //route: RouteWhereYouGo(), page: null,
                  ),
                );
              },
            ),
  ...
  Widget card(String title, String subtitle, String image, Widget route) {
    ...
    return Opacity(
      ...
      child: InkWell(
        ...
        splashColor: Colors.transparent,
        onTap: () {
          //Navigator.of(context).push(MyFadeRoute(route: route, page: null));
          Navigator.of(context)
              .push(MyFadeRoute(route: route, page: build(context)));
        },
        child: Container(
          width: _w / 2.36,
          height: _w / 1.8,
